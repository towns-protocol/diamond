...
contract ERC6909Test is TestUtils {
    ...
    function test_totalSupply_gas() public givenTokensAreMinted(address(this), 1, 1 ether) {
    ...
    function test_totalSupply(
        ...
        public
        givenTokensAreMinted(address(this), tokenId, amount)
    {
        assertEq(facet.totalSupply(tokenId), amount);
    }

    function test_balanceOf_gas() public givenTokensAreMinted(address(this), 1, 1 ether) {
    ...
    function test_balanceOf(
        ...
        public
        givenTokensAreMinted(to, tokenId, amount)
    {
    ...
    function test_allowance(
        ...
        public
        givenAccountIsApproved(owner, spender, tokenId, amount)
    {
        assertEq(facet.allowance(owner, spender, tokenId), amount);
    }

    function test_isOperator_gas() public givenOperatorIsSet(address(this), address(1), true) {
    ...
    function test_isOperator(
        ...
        public
        givenOperatorIsSet(owner, spender, approved)
    {
        assertEq(facet.isOperator(owner, spender), approved);
    }

    function test_transfer_gas() public givenTokensAreMinted(address(this), 1, 1 ether) {
    ...
    function test_transfer(
        ...
        public
        givenTokensAreMinted(from, tokenId, amount)
    {
        vm.assume(from != to);
    ...
    function test_transferZeroAmount(address from, address to, uint256 tokenId) public {
    ...
    function test_approve(address owner, address spender, uint256 tokenId, uint256 amount) public {
    ...
    function test_transferFrom_withAllowance(
        ...
        public
        givenTokensAreMinted(owner, tokenId, amount)
    {
        vm.assume(owner != ZERO_ADDRESS);
        vm.assume(spender != ZERO_ADDRESS);
    ...
    function test_setOperator_gas() public givenOperatorIsSet(address(this), address(1), true) {
        assertTrue(facet.isOperator(address(this), address(1)));
    }

    function test_setOperator(address owner, address operator, bool approved) public {
        vm.assume(owner != ZERO_ADDRESS);
        vm.assume(operator != ZERO_ADDRESS);
        vm.assume(owner != operator);
    ...
    function test_burn_gas() public givenTokensAreMinted(address(this), 1, 1 ether) {
    ...
    function test_mint_gas() public givenTokensAreMinted(address(this), 1, 1 ether) {
        assertEq(facet.balanceOf(address(this), 1), 1 ether);
        assertEq(facet.totalSupply(1), 1 ether);
    }
    ...
    function test_zeroAmountOperations(address user, address recipient, uint256 tokenId) public {
