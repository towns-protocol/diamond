...
import {IERC20PermitBase} from "src/facets/token/ERC20/permit/IERC20PermitBase.sol";
...
contract ERC20Test is SoladyTest, IERC20PermitBase, IERC20Errors {
    ...
    function setUp() public {
        token = MockERC20(LibClone.deployERC1967(address(new MockERC20())));
    ...
    function testTransferInsufficientBalanceReverts() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(ERC20InsufficientBalance.selector, address(this), 0.9e18, 1e18)
        );
    ...
    function testTransferFromInsufficientAllowanceReverts() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(ERC20InsufficientAllowance.selector, address(this), 0.9e18, 1e18)
        );
    ...
    function testTransferFromInsufficientBalanceReverts() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(ERC20InsufficientBalance.selector, from, 0.9e18, 1e18)
        );
        token.transferFrom(from, address(0xBEEF), 1e18);
    }
        ...
        if (t.amount > totalSupply) {
            vm.expectRevert(
                abi.encodeWithSelector(
                    ERC20InsufficientBalance.selector, t.owner, totalSupply, t.amount
                )
            );
    ...
    function testDirectSpendAllowance(uint256) public {
        ...
        if (allowance == type(uint256).max) {
            ...
            vm.expectRevert(
                abi.encodeWithSelector(
                    ERC20InsufficientAllowance.selector, t.to, allowance, t.amount
                )
            );
            token.directSpendAllowance(t.owner, t.to, t.amount);
        } else {
        ...
        public
    {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(ERC20InsufficientBalance.selector, to, mintAmount, burnAmount)
        );
        ...
        public
    {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                ERC20InsufficientBalance.selector, address(this), mintAmount, sendAmount
            )
        );
        ...
        public
    {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                ERC20InsufficientAllowance.selector, address(this), approval, amount
            )
        );
        ...
        public
    {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(ERC20InsufficientBalance.selector, from, mintAmount, sendAmount)
        );
    ...
    function testPermitPastDeadlineReverts(uint256) public {
        ...
        vm.expectRevert(abi.encodeWithSelector(ERC2612ExpiredSignature.selector, t.deadline));
        _permit(t);
    }
