...
abstract contract EIP712Utils is Test {
        ...
        returns (uint8 v, bytes32 r, bytes32 s)
    {
        ...
        bytes32 structHash =
            keccak256(abi.encode(PERMIT_TYPEHASH, owner, spender, value, nonces, deadline));
    ...
    function signIntent(
        ...
        returns (uint8 v, bytes32 r, bytes32 s)
    {
        bytes32 typeDataHash =
            MessageHashUtils.toTypedDataHash(EIP712Facet(eip712).DOMAIN_SEPARATOR(), structHash);
