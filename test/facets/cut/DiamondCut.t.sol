...
contract DiamondCutTest is TestUtils, IDiamondCutBase, IOwnableBase {
    ...
    function test_revertWhenFacetIsZeroAddress() external {
        ...
        vm.expectRevert(abi.encodeWithSelector(DiamondCut_InvalidFacet.selector, address(0)));
        vm.prank(deployer);
        diamondCut.diamondCut(extensions, address(0), "");
    }
    ...
    function test_revertsWhenFacetIsNotContract() external {
        ...
        vm.expectRevert(abi.encodeWithSelector(DiamondCut_InvalidFacet.selector, facet));
        vm.prank(deployer);
    ...
    function test_revertsWhenSelectorArrayIsEmpty() external {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(DiamondCut_InvalidFacetSelectors.selector, address(mockFacet))
        );
        vm.prank(deployer);
        diamondCut.diamondCut(facetCuts, address(0), "");
    }
    ...
    function test_revertWhenAddingFunctionAlreadyExists() external {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                DiamondCut_FunctionAlreadyExists.selector, extensions[0].functionSelectors[0]
            )
        );
        vm.prank(deployer);
        diamondCut.diamondCut(extensions, address(0), "");
    ...
    function test_revertWhenRemovingFromOtherFacet() external {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                DiamondCut_InvalidFacetRemoval.selector, address(mockFacet), facetSelectors[0]
            )
        );
        vm.prank(deployer);
        diamondCut.diamondCut(facetCuts, address(0), "");
    ...
    function test_revertWhenReplacingFunctionFromSameFacet() external {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                DiamondCut_FunctionFromSameFacetAlreadyExists.selector, facetSelectors[0]
            )
        );
        vm.prank(deployer);
        diamondCut.diamondCut(facetCuts, address(0), "");
