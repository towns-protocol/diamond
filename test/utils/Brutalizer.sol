...
contract Brutalizer {
  ...
  uint256 private constant _LPRNG_MULTIPLIER =
  ...
  function _brutalizeMemory() internal view {
    ...
    assembly {
      ...
      offset := add(
        offset,
        mul(iszero(and(r, 0xf00000000)), and(shr(64, r), 0xfffff))
      )
  ...
  /// @dev Returns the result with the lower bits dirtied.
  function _brutalizedBytes3(
    bytes3 value
  ) internal pure returns (bytes3 result) {
  ...
  /// @dev Returns the result with the upper bits dirtied.
  function _brutalizedUint40(
    uint40 value
  ) internal pure returns (uint40 result) {
  ...
  /// @dev Returns the result with the lower bits dirtied.
  function _brutalizedBytes5(
    bytes5 value
  ) internal pure returns (bytes5 result) {
  ...
  /// @dev Returns the result with the upper bits dirtied.
  function _brutalizedUint48(
    uint48 value
  ) internal pure returns (uint48 result) {
  ...
  /// @dev Returns the result with the upper bits dirtied.
  function _brutalizedUint56(
    uint56 value
  ) internal pure returns (uint56 result) {
  ...
  /// @dev Returns the result with the lower bits dirtied.
  function _brutalizedBytes7(
    bytes7 value
  ) internal pure returns (bytes7 result) {
  ...
  /// @dev Returns the result with the upper bits dirtied.
  function _brutalizedUint72(
    uint72 value
  ) internal pure returns (uint72 result) {
  ...
  /// @dev Returns the result with the lower bits dirtied.
  function _brutalizedBytes9(
    bytes9 value
  ) internal pure returns (bytes9 result) {
  ...
  /// @dev Returns the result with the upper bits dirtied.
  function _brutalizedUint80(
    uint80 value
  ) internal pure returns (uint80 result) {
  ...
  /// @dev Returns the result with the upper bits dirtied.
  function _brutalizedUint88(
    uint88 value
  ) internal pure returns (uint88 result) {
  ...
  /// @dev Returns the result with the lower bits dirtied.
  function _brutalizedBytes11(
    bytes11 value
  ) internal pure returns (bytes11 result) {
  ...
  /// @dev Returns the result with the upper bits dirtied.
  function _brutalizedUint104(
    uint104 value
  ) internal pure returns (uint104 result) {
  ...
  /// @dev Returns the result with the lower bits dirtied.
  function _brutalizedBytes13(
    bytes13 value
  ) internal pure returns (bytes13 result) {
  ...
  /// @dev Returns the result with the lower bits dirtied.
  function _brutalizedBytes14(
    bytes14 value
  ) internal pure returns (bytes14 result) {
  ...
  /// @dev Returns the result with the upper bits dirtied.
  function _brutalizedUint120(
    uint120 value
  ) internal pure returns (uint120 result) {
  ...
  /// @dev Returns the result with the upper bits dirtied.
  function _brutalizedUint136(
    uint136 value
  ) internal pure returns (uint136 result) {
  ...
  /// @dev Returns the result with the lower bits dirtied.
  function _brutalizedBytes17(
    bytes17 value
  ) internal pure returns (bytes17 result) {
  ...
  /// @dev Returns the result with the upper bits dirtied.
  function _brutalizedUint144(
    uint144 value
  ) internal pure returns (uint144 result) {
  ...
  /// @dev Returns the result with the lower bits dirtied.
  function _brutalizedBytes18(
    bytes18 value
  ) internal pure returns (bytes18 result) {
  ...
  /// @dev Returns the result with the upper bits dirtied.
  function _brutalizedUint152(
    uint152 value
  ) internal pure returns (uint152 result) {
  ...
  /// @dev Returns the result with the lower bits dirtied.
  function _brutalizedBytes19(
    bytes19 value
  ) internal pure returns (bytes19 result) {
  ...
  /// @dev Returns the result with the upper bits dirtied.
  function _brutalizedUint160(
    uint160 value
  ) internal pure returns (uint160 result) {
  ...
  /// @dev Returns the result with the upper bits dirtied.
  function _brutalizedUint168(
    uint168 value
  ) internal pure returns (uint168 result) {
  ...
  /// @dev Returns the result with the lower bits dirtied.
  function _brutalizedBytes21(
    bytes21 value
  ) internal pure returns (bytes21 result) {
  ...
  /// @dev Returns the result with the upper bits dirtied.
  function _brutalizedUint176(
    uint176 value
  ) internal pure returns (uint176 result) {
  ...
  /// @dev Returns the result with the upper bits dirtied.
  function _brutalizedUint184(
    uint184 value
  ) internal pure returns (uint184 result) {
  ...
  /// @dev Returns the result with the lower bits dirtied.
  function _brutalizedBytes23(
    bytes23 value
  ) internal pure returns (bytes23 result) {
  ...
  /// @dev Returns the result with the upper bits dirtied.
  function _brutalizedUint200(
    uint200 value
  ) internal pure returns (uint200 result) {
  ...
  /// @dev Returns the result with the upper bits dirtied.
  function _brutalizedUint208(
    uint208 value
  ) internal pure returns (uint208 result) {
  ...
  /// @dev Returns the result with the lower bits dirtied.
  function _brutalizedBytes26(
    bytes26 value
  ) internal pure returns (bytes26 result) {
  ...
  /// @dev Returns the result with the upper bits dirtied.
  function _brutalizedUint216(
    uint216 value
  ) internal pure returns (uint216 result) {
  ...
  /// @dev Returns the result with the lower bits dirtied.
  function _brutalizedBytes27(
    bytes27 value
  ) internal pure returns (bytes27 result) {
  ...
  /// @dev Returns the result with the upper bits dirtied.
  function _brutalizedUint224(
    uint224 value
  ) internal pure returns (uint224 result) {
  ...
  /// @dev Returns the result with the upper bits dirtied.
  function _brutalizedUint232(
    uint232 value
  ) internal pure returns (uint232 result) {
  ...
  /// @dev Returns the result with the lower bits dirtied.
  function _brutalizedBytes29(
    bytes29 value
  ) internal pure returns (bytes29 result) {
  ...
  /// @dev Returns the result with the upper bits dirtied.
  function _brutalizedUint240(
    uint240 value
  ) internal pure returns (uint240 result) {
  ...
  /// @dev Returns the result with the lower bits dirtied.
  function _brutalizedBytes30(
    bytes30 value
  ) internal pure returns (bytes30 result) {
  ...
  /// @dev Returns the result with the upper bits dirtied.
  function _brutalizedUint248(
    uint248 value
  ) internal pure returns (uint248 result) {
  ...
  /// @dev Returns the result with the lower bits dirtied.
  function _brutalizedBytes31(
    bytes31 value
  ) internal pure returns (bytes31 result) {
  ...
  function __brutalizedBytesN(
    bytes32 x,
    uint256 s
  ) private pure returns (bytes32) {
    return
      bytes32(uint256((__brutalizerRandomness(uint256(x)) >> s) ^ uint256(x)));
  }

  /// @dev Returns a brutalizer randomness.
  function __brutalizerRandomness(
    uint256 seed
    ...
    assembly {
      ...
      mstore(0x10, result)
      if iszero(
        and(7, shr(128, mulmod(result, _LPRNG_MULTIPLIER, _LPRNG_MODULO)))
      ) {
        result := 0
      }
    }
