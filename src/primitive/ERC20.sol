...
library ERC20Lib {
    ...
    function approve(MinimalERC20Storage storage self, address spender, uint256 value) internal {
        _approve(self, msg.sender, spender, value);
    }

    /// @dev Moves a `value` amount of tokens from the caller's account to `to`.
    function transfer(MinimalERC20Storage storage self, address to, uint256 value) internal {
    ...
    function mint(MinimalERC20Storage storage self, address account, uint256 value) internal {
    ...
    function burn(MinimalERC20Storage storage self, address account, uint256 value) internal {
    ...
    function _spendAllowance(
        ...
        internal
    {
        (bool insufficient, uint256 currentAllowance) =
            _spendAllowanceNoRevert(self, owner, spender, value);
        if (insufficient) {
    ...
    function _spendAllowanceNoRevert(
        ...
        internal
        returns (bool insufficient, uint256 currentAllowance)
    {
    ...
    function _deductBalance(
        ...
        internal
    {
        (bool insufficient, uint256 fromBalance) = _deductBalanceNoRevert(self, from, value);
        if (insufficient) {
    ...
    function _deductBalanceNoRevert(
        ...
        internal
        returns (bool insufficient, uint256 fromBalance)
    {
